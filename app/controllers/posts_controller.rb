class PostsController < ApplicationController
  before_action :require_user_signed_in, only: %i[edit create update destroy]
  before_action :set_post, only: %i[show apply_to preview edit update destroy vote]
  before_action :require_user_owns_post, only: %i[preview edit update destroy]
